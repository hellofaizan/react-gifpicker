import React, { ReactHTML, ReactNode, RefObject } from 'react';

declare enum StaggeredItemSpan {
    /** Occupy one column */
    Single = 1,
    /** Occupy total columnCount as span */
    Full = 99999
}
declare enum StaggeredAlignment {
...
interface StaggeredGridProps extends React.HTMLProps<HTMLElement> {
...
interface StaggeredGridItemProps extends React.HTMLProps<HTMLElement> {
...
declare class StaggeredGrid<ItemType> extends React.Component<StaggeredGridProps & typeof StaggeredGrid.defaultProps, StaggeredGridState> {
    static defaultProps: {
        elementType: string;
        alignment: StaggeredAlignment;
        calculateHeight: boolean;
 ...
 */
declare function createStaggeredGridController(): StaggeredGridController;

declare type StaggeredGridContextType = {
    updateItem: (index: number, itemColumnSpan: StaggeredItemSpan | number, height: number, update: (width: number, x: number, y: number) => void) => void;
    removeItem: (index: number) => void;
};
declare const StaggeredGridContext: React.Context<StaggeredGridContextType>;
declare function useStaggeredGrid(): StaggeredGridContextType;

declare class StaggeredGridItem extends React.Component<StaggeredGridItemProps & typeof StaggeredGridItem.defaultProps, PositionedItem> {
    ...
    reportData(): void;
    componentDidMount(): void;
    componentDidUpdate(prevProps: Readonly<StaggeredGridItemProps & typeof StaggeredGridItem.defaultProps>, prevState: Readonly<PositionedItem>, snapshot?: any): void;
    componentWillUnmount(): void;
    transform(itemPos: PositionedItem): React.HTMLProps<HTMLElement>;
 ...
 */
declare function useStaggeredItemPosition<T extends HTMLElement>(index: number, spans: number, itemHeight?: number, ref?: RefObject<T>, initialPosition?: PositionedItem): PositionedItem;
/**
 * use StaggeredGridItem as this is still a work in progress
 * @param props see StaggeredGridItemProps
 */
declare function StaggeredGridItemFunctional(props: StaggeredGridItemProps & typeof StaggeredGridItemFunctional.defaultProps): JSX.Element;
declare namespace StaggeredGridItemFunctional {
    var defaultProps: {
        spans: number;
    };
}

export { PositionedItem, StaggeredAlignment, StaggeredGrid, StaggeredGridContext, StaggeredGridContextType, StaggeredGridController, StaggeredGridItem, StaggeredGridItemFunctional, StaggeredGridItemProps, StaggeredGridProps, StaggeredItemSpan, createStaggeredGridController, useStaggeredGrid, useStaggeredItemPosition };
